...
export interface Word {
  ...
  phono_prob_sum_log: number | null;  // Sum of log biphone probabilities (Vitevitch metric)
  positional_prob_avg: number | null;  // Mean positional segment probability
}
