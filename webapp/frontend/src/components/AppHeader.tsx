      ...
      >
        <Box sx={{ p: { xs: 2, sm: 3 }, height: '100%', overflow: 'auto' }}>
          ...
          <Typography variant="body2" color="text.secondary" paragraph>
            ...
            datasets. Filtered vocabulary: 48,720 English words with comprehensive phonological and psycholinguistic properties.
          </Typography>
          ...
          <List sx={{ py: 0 }}>
            ...
            <ListItemButton onClick={() => handleCitationClick('phonological')} sx={{ borderRadius: 1 }}>
              <ListItemText
                ...
                secondary="WCM, phonotactic probability, distinctive features"
              />
              <ChevronRightIcon />
            </ListItemButton>
