...
PhonoLex integrates data and methodologies from multiple research sources.

## Data Sources

### CMU Pronouncing Dictionary
Carnegie Mellon University. (2014). The CMU Pronouncing Dictionary (125,764 words).
http://www.speech.cs.cmu.edu/cgi-bin/cmudict

### PHOIBLE
Moran, S., & McCloy, D. (2019). PHOIBLE 2.0 (2,716 languages, 38 distinctive features).
